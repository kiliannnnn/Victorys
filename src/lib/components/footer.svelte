<footer class="w-full bg-zinc-200 text-zinc-900 p-6 dark:bg-zinc-800 dark:text-zinc-300">
  ...
  <div class="w-full mt-8 border-t dark:border-zinc-600">
    <p class="text-center text-sm pt-4 pb-2">&copy; {new Date().getFullYear()} Victorys. All rights reserved.</p>
  </div>
</footer>
