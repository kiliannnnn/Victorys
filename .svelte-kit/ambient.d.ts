...
declare module '$env/static/private' {
	export const VITE_PB_URL: string;
	export const VITE_PB_ADMIN_EMAIL: string;
	export const VITE_PB_ADMIN_PASS: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		VITE_PB_URL: string;
		VITE_PB_ADMIN_EMAIL: string;
		VITE_PB_ADMIN_PASS: string;
